...
/**
 * Refactored ViewSession component using modular architecture
 */
export class ViewSessionRefactored extends BaseComponent {
...
customElements.define('view-session-refactored', ViewSessionRefactored);