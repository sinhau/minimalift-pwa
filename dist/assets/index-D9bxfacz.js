var L=Object.defineProperty;var F=(c,i,e)=>i in c?L(c,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):c[i]=e;var a=(c,i,e)=>F(c,typeof i!="symbol"?i+"":i,e);(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&t(n)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();class M extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
    ...
    `:""}renderTimer(){const e=this.getCurrentExercise(),t=this.getCurrentBlock(),s=t?.timerType&&t.timerType!=="none";if(t?.timerType==="interval"&&t.timerConfig?.exercisesPerInterval&&t.timerConfig.exercisesPerInterval>1){const p=(t.timerConfig.intervalSec||120)/60,d=t.timerConfig.exercisesPerInterval;if(this.currentTimer){const m=this.currentTimer.getRemainingInCurrentPeriod(),y=this.currentTimer.getCurrentRound(),w=this.currentTimer.getTotalRounds(),S=v.formatTime(m),T=this.getTimerProgress();return`
        ...
        `}if(!s&&e){const p=e.sets||1,d=this.currentSetIndex+1;if(this.isRestingBetweenSets&&this.currentTimer){const m=this.currentTimer.getRemainingInCurrentPeriod(),y=v.formatTime(m),w=this.currentTimer.getElapsedTime(),S=this.currentTimer.getDuration(),T=Math.min(w/S,1);return`
          <div class="timer-section">
      ...
      `;const r=this.currentTimer.getRemainingInCurrentPeriod(),n=this.currentTimer.getCurrentRound(),o=this.currentTimer.getTotalRounds(),l=v.formatTime(r),u=this.getTimerProgress(),h=this.getTimerPhase();return`
      <div class="timer-section">
    ...
    `)}setupEventListeners(){this.shadowRoot&&this.addEventListener("click",()=>{this.isUpdateAvailable&&this.applyUpdate()})}show(){this.classList.add("visible")}async applyUpdate(){this.classList.add("updating");const e=this.shadowRoot?.querySelector(".indicator");e&&(e.innerHTML=`
      ...
      `),await $.applyUpdate()}}customElements.define("update-indicator",K);class J extends HTMLElement{constructor(){super();a(this,"shadow");this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}disconnectedCallback(){this.cleanup()}setupEventListeners(){}cleanup(){}setHTML(e){this.shadow&&(this.shadow.innerHTML=e)}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}$(e){return this.shadow?.querySelector(e)??null}$$(e){return this.shadow?.querySelectorAll(e)??[]}}class Q extends J{constructor(){super(...arguments);a(this,"latestEvent",null)}render(){this.setHTML(`
      <style>
        :host {
          display: block;
        }
    ...
    `}});
//# sourceMappingURL=index-D9bxfacz.js.map
